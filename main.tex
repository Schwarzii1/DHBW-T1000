...
\usepackage{fancyhdr}
\usepackage{setspace}
\usepackage[backend=biber, citestyle=authoryear, bibstyle=authoryear]{biblatex}      % Bibliothek für Zitate
...
\DeclareCiteCommand{\cite}
  {\usebibmacro{prenote}}
  {\printnames{labelname} \printtext{, }\printfield{year}}
  {\multicitedelim}
...
\def\vTitel{Analyse und Bewertung von Asset Inventory Tools zur Erfassung von OT-Geräte-Attributen}                           %% 
\def\vUntertitel{}                      %% 
...
\begin{document}
  ...
  \include{chapter/OT-Security}
  \include{chapter/Praxisprojekt}
